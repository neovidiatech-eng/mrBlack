...
export const metadata: Metadata = {
  ...
  description:
    "تسوق أفضل وأحدث النظارات الطبية والشمسية والعدسات اللاصقة بأفضل الأسعار. تشكيلة واسعة من الماركات العالمية لتناسب جميع الأذواق.",
  keywords: [
    "نظارات",
    "بصريات",
    "نظارات شمسية",
  ...
  openGraph: {
    ...
    title: "MR.BLACK",
    description:
      "تسوق أفضل النظارات الطبية والشمسية والعدسات اللاصقة بأفضل الأسعار.",
    siteName: "MR.BLACK",
    images: [
      {
        url: "/logo.jpeg",
